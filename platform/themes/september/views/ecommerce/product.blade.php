            ...
            <div class="product__header">
                ...
                <div class="product__info">
                    <div class="product__info-header">
                        <h2 class="product__title">{!! BaseHelper::clean($product->name) !!}</h2>
                        {{-- @code --}}
                        @if ($product->brand_id)
                            <img class="float-right product__brand" style=""
                                src="{{ RvMedia::getImageUrl($product->brand->logo, null, false, RvMedia::getDefaultImage()) }}"
                                alt="{{ $product->brand->name }}" loading="lazy" />
                        @endif
                        @if (0)
                    ...
                    <div class="product__price @if ($product->front_sale_price !== $product->price) sale @endif">
                        ...
                        <p>
                            ...
                            @if (EcommerceHelper::isCompareEnabled())
                                <a class="product__add-wishlist ml-3 js-add-to-compare-button"
                                    data-url="{{ route('public.compare.add', $product->id) }}" href="#"><i
                                        class="feather icon icon-plus-circle"></i> <span>{{ __('Compare') }}</span></a>
                            @endif
                        </p>
                    </div>
                    ...
                    <div class="product__shopping">
                        @if (EcommerceHelper::isCartEnabled())
                            <form class="single-variation-wrap add-to-cart-form" method="POST"
                                ...
                                <div class="form-group product__attribute product__qty">
                                    ...
                                    <div class="form-group__content">
                                        <div class="form-group--number">
                                            ...
                                            <input class="form-control qty-input" name="qty" type="number"
                                                value="1" id="qty-input">
                                ...
                                <button type="submit" @if ($product->isOutOfStock()) disabled @endif
                                    class="btn--custom btn--outline btn--rounded btn-add-cart @if (!EcommerceHelper::isQuickBuyButtonEnabled())  @endif @if ($product->isOutOfStock()) btn-disabled @endif">
                                    {{ __('Add to cart') }}
                                </button>
                                {{-- <span class="whatsapp-msg">
                                    https://api.whatsapp.com/send?phone=201001516023 &amp;text=Hello, I Seen This
                                ...
                                @if (EcommerceHelper::isQuickBuyButtonEnabled())
                                    ...
                                    <button type="submit" name="checkout"
                                        ...
                                        class="btn--custom btn--rounded btn-add-cart @if ($product->isOutOfStock()) btn-disabled @endif">
                                        {{ __('Quick Buy') }}
                                    </button>
                                @endif
