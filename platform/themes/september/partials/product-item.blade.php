        ...
        <div class="product__wrapper">
            <div class="product__thumbnail">
                ...
                @if (EcommerceHelper::isWishlistEnabled())
                    <a class="product__favorite js-add-to-wishlist-button" href="#"
                ...
                <ul class="product__actions">
                    @if (EcommerceHelper::isCartEnabled() && !$product->isOutOfStock())
                        <li><a class="add-to-cart-button" data-id="{{ $product->id }}" href="#"
                                data-url="{{ route('public.cart.add-to-cart') }}">{{ __('Add to cart') }}</a></li>
                    @endif
                </ul>
                            ...
                            @if ($attribute->display_layout == 'visual')
                                ...
                                <li>
                                    <div class="custom-checkbox">
                                        <span
                                            style="background-color: {{ $attribute->color }}; cursor: initial;"></span>
                                    </div>
                                </li>
                            @endif
                        @endforeach
