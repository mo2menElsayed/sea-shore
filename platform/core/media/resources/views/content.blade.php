<div class="rv-media-container">
    <x-core::card class="rv-media-wrapper">
        ...
        <x-core::offcanvas id="rv-media-aside" @class([
            ...
            <x-core::offcanvas.body class="p-0">
                <x-core::list-group :flush="true">
                    ...
                    <x-core::list-group.item :action="true" class="js-rv-media-change-filter" data-type="filter"
                ...
                <x-core::list-group :flush="true">
                    ...
                    <x-core::list-group.item :action="true" class="js-rv-media-change-filter" data-type="view_in"
        ...
        <div class="rv-media-main-wrapper">
            <x-core::card.header class="flex-column rv-media-header p-0">
                <div
                    ...
                    <div class="d-flex gap-2 justify-content-between w-100 w-md-auto rv-media-actions">
                        <x:core::button class="d-flex d-md-none" icon="ti ti-menu-2" :icon-only="true"
                            data-bs-toggle="offcanvas" href="#rv-media-aside" />

                        <div class="btn-list">
                            @if (RvMedia::hasPermission('files.create'))
                                <x-core::dropdown :label="trans('core/media::media.upload')" icon="ti ti-upload" color="primary">
                                    <x-core::dropdown.item :label="trans('core/media::media.upload_from_local')" class="js-dropzone-upload dropdown-item"
                                        icon="ti ti-upload" />

                                    <x-core::dropdown.item :label="trans('core/media::media.upload_from_url')" class="js-download-action dropdown-item"
                                        icon="ti ti-link" />
                                </x-core::dropdown>
                            @endif

                            @if (RvMedia::hasPermission('folders.create'))
                                <x-core::button type="button" color="primary" :tooltip="trans('core/media::media.create_folder')"
                                    class="js-create-folder-action" icon="ti ti-folder-plus" :icon-only="true" />
                            @endif

                            <x-core::button type="button" color="primary" :tooltip="trans('core/media::media.refresh')" class="js-change-action"
                                icon="ti ti-refresh" :icon-only="true" data-type="refresh" />

                            @if (RvMedia::getConfig('sidebar_display') !== 'vertical')
                                <x-core::dropdown wrapper-class="d-none d-md-block">
                                    <x-slot:trigger>
                                        <x-core::button type="button" color="primary" icon="ti ti-filter"
                                            class="dropdown-toggle js-rv-media-change-filter-group js-filter-by-type"
                                            data-bs-toggle="dropdown" :tooltip="trans('core/media::media.filter')">
                                            <span class="js-rv-media-filter-current"></span>
                                        </x-core::button>
                                    </x-slot:trigger>

                                    <x-core::dropdown.item :label="trans('core/media::media.everything')" icon="ti ti-recycle"
                                        class="js-rv-media-change-filter" data-type="filter" data-value="everything" />

                                    @if (array_key_exists('image', RvMedia::getConfig('mime_types', [])))
                                        <x-core::dropdown.item :label="trans('core/media::media.image')" icon="ti ti-photo"
                                            class="js-rv-media-change-filter" data-type="filter" data-value="image" />
                                    @endif

                                    @if (array_key_exists('video', RvMedia::getConfig('mime_types', [])))
                                        <x-core::dropdown.item :label="trans('core/media::media.video')" icon="ti ti-video"
                                            class="js-rv-media-change-filter" data-type="filter" data-value="video" />
                                    @endif

                                    <x-core::dropdown.item :label="trans('core/media::media.document')" icon="ti ti-file"
                                        class="js-rv-media-change-filter" data-type="filter" data-value="document" />
                                </x-core::dropdown>

                                <x-core::dropdown wrapper-class="d-none d-md-block">
                                    <x-slot:trigger>
                                        <x-core::button type="button" color="primary" icon="ti ti-eye"
                                            class="dropdown-toggle js-rv-media-change-filter-group js-filter-by-view-in"
                                            data-bs-toggle="dropdown" :tooltip="trans('core/media::media.view_in')">
                                            <span class="js-rv-media-filter-current"></span>
                                        </x-core::button>
                                    </x-slot:trigger>

                                    <x-core::dropdown.item :label="trans('core/media::media.all_media')" icon="ti ti-world"
                                        class="js-rv-media-change-filter" data-type="view_in" data-value="all_media" />

                                    <x-core::dropdown.item :label="trans('core/media::media.trash')" icon="ti ti-trash"
                                        class="js-rv-media-change-filter" data-type="view_in" data-value="trash" />

                                    <x-core::dropdown.item :label="trans('core/media::media.recent')" icon="ti ti-clock"
                                        class="js-rv-media-change-filter" data-type="view_in" data-value="recent" />

                                    <x-core::dropdown.item :label="trans('core/media::media.favorites')" icon="ti ti-star"
                                        class="js-rv-media-change-filter" data-type="view_in"
                                        data-value="favorites" />
                                </x-core::dropdown>
                            @endif

                            @if (RvMedia::hasAnyPermission(['folders.destroy', 'files.destroy']))
                                <x-core::button type="button" color="danger" class="d-none js-files-action"
                                    data-action="empty_trash" icon="ti ti-trash">
                    ...
                    <div class="rv-media-search">
                        <form class="input-search-wrapper" action="" method="GET">
                            <div class="input-group">
                                ...
                                <x-core::button type="submit" icon="ti ti-search" :icon-only="true" />
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="w-100 d-flex flex-wrap gap-3 p-2">
                    ...
                    <div
                        ...
                        <div class="btn-list" role="group">
                            <x-core::dropdown :label="trans('core/media::media.sort')" icon="ti ti-sort-a-z">
                                @foreach ($sorts as $key => $item)
                                    <x-core::dropdown.item :label="$item['label']" :icon="$item['icon']"
                                        class="js-rv-media-change-filter" data-type="sort_by" :data-value="$key" />
                                @endforeach
                            </x-core::dropdown>

                            <x-core::dropdown :label="trans('core/media::media.actions')" icon="ti ti-hand-finger"
                                wrapper-class="rv-dropdown-actions" :disabled="true" />
                        </div>
                        
                        <div class="btn-group js-rv-media-change-view-type ms-2" role="group">
                            <x-core::button type="button" data-type="tiles" icon="ti ti-layout-grid"
                                :icon-only="true" />
                            <x-core::button type="button" data-type="list" icon="ti ti-layout-list"
                                :icon-only="true" />
                        </div>
                        <x-core::button tag="label" for="media_details_collapse"
                            class="collapse-panel ms-2 d-none d-sm-flex" icon="ti ti-arrow-bar-right"
                            :icon-only="true" />
                    </div>
                </div>
            </x-core::card.header>
            ...
            <footer class="d-none rv-media-footer">
                <x-core::button type="button" color="primary" class="js-insert-to-editor">
            ...
            <x-core::card>
                <x-core::card.header class="position-relative">
                    ...
                    <x-core::button class="close-pane position-absolute top-50 bg-primary text-white text-center p-0">
                        <x-core::icon class="m-0" name="ti ti-x" />
                    </x-core::button>
                </x-core::card.header>
...
<x-core::modal id="modal_add_folder" :title="trans('core/media::media.create_folder')" :has-form="true" :form-attrs="['class' => 'rv-form form-add-folder']">
    <x-core::form.text-input name="name" type="text" :placeholder="trans('core/media::media.folder_name')">
        <x-slot:append>
...
<x-core::modal id="modal_rename_items" :title="trans('core/media::media.rename')" :has-form="true" :form-attrs="['class' => 'form-rename']">
...
<x-core::modal id="modal_alt_text_items" :title="trans('core/media::media.alt_text')" :has-form="true" :form-attrs="['class' => 'form-alt-text']">
...
<x-core::modal id="modal_trash_items" :title="trans('core/media::media.move_to_trash')" :has-form="true" :form-attrs="['class' => 'form-delete-items']">
    <p>{{ trans('core/media::media.confirm_trash') }}</p>

    <x-core::form.checkbox :label="trans('core/media::media.skip_trash')" :helper_text="trans('core/media::media.skip_trash_description')" name="skip_trash" :checked="false"
        id="skip_trash" />
    ...
    <x-slot:footer>
        ...
        <button type="button" class="btn btn-primary"
            data-bs-dismiss="modal">{{ trans('core/media::media.close') }}</button>
    </x-slot:footer>
</x-core::modal>

<x-core::modal id="modal_delete_items" :title="trans('core/media::media.confirm_delete')" :has-form="true" :form-attrs="['class' => 'form-delete-items']">
...
<x-core::modal id="modal_empty_trash" :title="trans('core/media::media.empty_trash_title')" :has-form="true" :form-attrs="['class' => 'form-empty-trash']">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" data-downloading="{{ trans('core/media::media.downloading') }}"
            ...
            <div class="modal-body">
                ...
                <div class="mt-2 modal-notice" id="modal-notice" style="max-height: 350px;overflow: auto"></div>
            </div>
        </div>
    </div>
</div>
<x-core::modal title="{{ trans('core/media::media.crop') }}" id="modal_crop_image" size="lg" :form-attrs="['class' => 'rv-form form-crop']"
    :has-form="true">
    <div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="mt-3">
                    <x-core::form.text-input label="{{ trans('core/media::media.cropper.height') }}"
                        name="dataHeight" id="dataHeight" />

                    <x-core::form.text-input label="{{ trans('core/media::media.cropper.width') }}" name="dataWidth"
                        id="dataWidth" />

                    <x-core::form.checkbox :label="trans('core/media::media.cropper.aspect_ratio')" name="aspectRatio" :checked="false"
                        id="aspectRatio" />
                </div>
            </div>
        </div>
...
<x-core::modal id="modal-properties" :title="trans('core/media::media.properties.name')">
    <input type="hidden" name="selected">

    <x-core::form.color-selector :label="trans('core/media::media.properties.color_label')" name="color" :choices="RvMedia::getFolderColors()" />
...
<x-core::modal id="modal_share_items" :title="trans('core/media::media.share')">
    <div class="share-items">
        ...
        <div class="mb-0 text-end">
            <x-core::button class="btn-icon" data-bb-toggle="clipboard"
...
<x-core::custom-template id="rv_action_item">
    <x-core::dropdown.item class="js-files-action" data-action="__action__" icon="__icon__" label="__name__" />
</x-core::custom-template>
...
<x-core::custom-template id="rv_media_rename_item">
    ...
    <x-core::form.checkbox data-folder-label="{{ trans('core/media::media.rename_physical_folder') }}"
        data-file-label="{{ trans('core/media::media.rename_physical_file') }}" label="__label__"
        name="rename_physical_file" data-bb-toggle="collapse" data-bb-target=".rename-physical-file-warning" />
