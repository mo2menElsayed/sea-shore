...
return [
    ...
    [
        ...
        'flag' => 'products.create.physical',
        'parent_flag' => 'products.create',
    ],
    [
        'name' => 'Create Digital',
        'flag' => 'products.create.digital',
        'parent_flag' => 'products.create',
    ],
    [
        'name' => 'Edit',
    ...
    [
        'name' => 'Featured',
        'flag' => 'products.featured',
        'parent_flag' => 'products.index',
    ],
    [
        'name' => 'Min Order',
        'flag' => 'products.min.order',
        'parent_flag' => 'products.index',
    ],
    [
        'name' => 'Max Order',
        'flag' => 'products.max.order',
        'parent_flag' => 'products.index',
    ],
